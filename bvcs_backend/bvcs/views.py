...
class StageFileView(APIView):
    '''
    POST    /api/repos/{id}/stage/ - stage a file for commit
    ...
    def post(self, request, repo_id):
        ...
        return Response(
            {'staged': uploaded_file.name},
            status=status.HTTP_200_OK,
        )

class CheckoutView(APIView):
    '''
    POST    /api/repos/{id}/checkout/{hash} - retrieve a specific version of a file
    '''
